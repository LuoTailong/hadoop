...
import cn.itcast.etl.pageviews.PageViewsBean;
import cn.itcast.etl.pageviews.VisitBean;
...
//		FileOutputFormat.setOutputPath(job, new Path(args[1]));
		FileInputFormat.setInputPaths(job, new Path("C:\\hadoop\\test\\output\\pageViews"));
		FileOutputFormat.setOutputPath(job, new Path("C:\\hadoop\\test\\output\\visit"));
