...
import cn.itcast.etl.preprocess.WebLogBean;
...
//		FileOutputFormat.setOutputPath(job, new Path(args[1]));
		...
		FileInputFormat.setInputPaths(job, new Path("C:\\hadoop\\test\\output\\webLog"));
		FileOutputFormat.setOutputPath(job, new Path("C:\\hadoop\\test\\output\\pageViews"));
